...
export const translations: Record<Language, Translations> = {
  ar: {
    ...
    faqA1: 'لا نطلب أبداً أي أرقام حسابات بنكية أو كلمات مرور سرية. «تحت البلاطة» و«افتكر» مصممان بمبدأ (الخصوصية أولاً)؛ كافة بيانات مدخراتك وملاحظاتك ومواعيدك يتم تشفيرها محلياً 100% داخل هاتفك فقط. لا نبيع بيانات، ولا نضع إعلانات، ولا يملك أي طرف ثالث إمكانية الوصول لأسرارك.',
    faqQ2: 'هل تطبيقا «تحت البلاطة» و«افتكر» مجانيان؟',
    faqA2: 'نعم! الميزات الأساسية والكاملة لإدارة الأمان المالي، والخزنات الذكية، وتصفية الذهن، والتنبيهات مجانية تماماً ومتاحة لكل الناس بدون أي إعلانات مزعجة على الإطلاق. نقدم فقط باقات اختيارية للميزات السحابية التشاركية للعائلات وفرق العمل.',
  ...
  en: {
    ...
    faqA1: 'Never. We never ask for bank credentials, card numbers, or secret passwords. Taht El Balata and Eftekir are architected on strict Privacy-First and Zero-Knowledge principles. All savings, notes, and records are 100% encrypted locally on your phone hardware. We do not sell data, display ads, or grant third parties access to your private life.',
    faqQ2: 'Are Taht El Balata and Eftekir free to use?',
    faqA2: 'Yes! The comprehensive core features for financial fortress vaults, cognitive thought capture, reminders, and offline tools are 100% free with zero intrusive advertisements. We solely offer optional premium tiers for collaborative multi-device family clouds.',
