...
export const SupportDocsModal: FC<SupportDocsModalProps> = ({
  ...
  return (
    ...
    >
      <div
        className="relative w-full max-w-4xl max-h-[92vh] bg-white rounded-3xl shadow-2xl border border-black/[0.1] flex flex-col overflow-hidden animate-scaleUp"
      ...
      >
        ...
        <div className="p-6 sm:p-8 border-b border-black/[0.06] bg-gradient-to-b from-neutral-50/90 to-white flex items-center justify-between gap-4 shrink-0">
          ...
          <button
            ...
            className="p-2.5 rounded-full bg-neutral-100 hover:bg-neutral-200 text-[#1d1d1f] transition-all cursor-pointer shrink-0"
            title={t.closeBtn}
          >
            <X className="w-5 h-5" />
          </button>
        ...
        <div className="px-6 sm:px-8 pt-4 pb-2 border-b border-black/[0.05] bg-white flex items-center gap-2 overflow-x-auto shrink-0">
          <button
            type="button"
            onClick={() => {
              playAppleClick();
            ...
            className={`px-4 py-2 rounded-full text-xs sm:text-sm font-bold transition-all flex items-center gap-2 cursor-pointer shrink-0 ${
              activeTab === 'team'
        ...
        <div className="p-6 sm:p-8 overflow-y-auto space-y-6 text-start">
                ...
                <div className="apple-card p-6 border border-black/[0.08] hover:border-black/[0.15] transition-all space-y-4">
                  ...
                  <div className="flex items-center gap-2 pt-2 border-t border-black/[0.05]">
                    <button
                      ...
                      className="px-3.5 py-2 rounded-xl bg-neutral-100 hover:bg-neutral-200 text-xs font-bold text-[#1d1d1f] flex items-center gap-1.5 transition-all cursor-pointer"
                    >
                    ...
                    <a
                      ...
                      className="apple-pill-btn px-4 py-2 bg-[#1d1d1f] hover:bg-black text-white text-xs font-bold flex items-center gap-1.5 cursor-pointer ml-auto"
                    >
                      <span>{t.supportSendEmail}</span>
                ...
                <div className="apple-card p-6 border border-black/[0.08] hover:border-black/[0.15] transition-all space-y-4">
                  ...
                  <div className="flex items-center gap-2 pt-2 border-t border-black/[0.05]">
                    ...
                    <a
                      ...
                      className="apple-pill-btn px-4 py-2 bg-[#25D366] hover:bg-[#20ba57] text-white text-xs font-bold flex items-center gap-1.5 cursor-pointer ml-auto shadow-sm"
                    >
                      <span>{t.supportOpenChat}</span>
                      <ExternalLink className="w-3.5 h-3.5" />
                    </a>
                  </div>
                </div>
                ...
                <div className="apple-card p-6 border border-black/[0.08] hover:border-black/[0.15] transition-all space-y-4">
                  ...
                  <div className="flex items-center gap-2 pt-2 border-t border-black/[0.05]">
                    ...
                    <a
                      ...
                      className="apple-pill-btn px-4 py-2 bg-[#0071e3] hover:bg-[#0077ed] text-white text-xs font-bold flex items-center gap-1.5 cursor-pointer ml-auto shadow-sm"
                    >
                      <span>{t.supportSendEmail}</span>
                      <ExternalLink className="w-3.5 h-3.5" />
                    </a>
            ...
            <div className="space-y-6 animate-fadeIn">
              <div className="p-5 rounded-2xl bg-purple-50/80 border border-purple-200 space-y-2">
                <div className="flex items-center gap-2 text-purple-900 font-bold text-sm sm:text-base">
                  ...
                  <span>{isAr ? 'دليل المعمارية والتوثيق الهندسي للمنظومة' : 'Engineering Architecture & System Whitepaper'}</span>
                </div>
                <p className="text-xs sm:text-sm text-purple-900/90 leading-relaxed">
                  {isAr
                    ? 'توثيق شامل لكيفية عمل المنظومة هندسياً، معايير التشفير العسكري، وبروتوكول المصافحة اللاسلكية بدون سحابة.'
                    : 'Detailed operational documentation on offline-first hardware encryption, zero-telemetry paradigms, and local P2P wireless bridging.'}
                </p>
              </div>

              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {/* Guide 1: Taht El Balata Security */}
                <div className="p-5 rounded-2xl bg-neutral-50 border border-black/[0.06] space-y-2.5">
